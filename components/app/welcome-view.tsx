...
function WelcomeImage() {
  return (
    ...
    // </svg>
    <img
      style={{ height: '6em', width: '17em', marginBottom: '1em', filter: "drop-shadow(0 0 2px white)" }}
      src="/realestate-bot/quarkLogo.png"
    ...
    <div ref={ref} className="flex h-full w-full items-center justify-center">
      <section className="bg-background flex flex-col items-center justify-center text-center p-6">
        ...
        <p className="text-foreground max-w-prose pt-1 leading-6 font-medium">
          Chat with Realtime Real Estate voice agent powered by Quarkgen's Voice AI over WebRTC.
        </p>
