...
>(
  (
    ...
    const startBtnRef = React.useRef<HTMLDivElement>(null);

    const handleBotSelect = (bot: BotFlow) => {
      onSelectBot?.(bot);
      // Smoothly scroll to the start button to keep user focused
      setTimeout(() => {
      ...
      >
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span
                      ...
                      style={{
                        ...
                        color: "#ffffff",
                        border: `1px solid ${selectedBot.accentColor}60`,
                      }}
                    >
                      {selectedBot.badge}
                    </span>
              ...
              <div className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-3.5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#c9a24c] hover:shadow-lg">
                ...
                <div className="px-1">
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-slate-600">
                    ...
                    smart water recycling, organic greens, and modern
                    eco-villas.
                  </p>
                </div>
                <div className="mt-4 flex items-center justify-between border-t border-slate-100 px-1 pt-2.5 text-[11px] font-medium text-slate-500">
            ...
            <div className="flex items-center gap-3.5 rounded-xl border border-sky-200/90 bg-gradient-to-br from-white to-sky-50/40 p-4 shadow-xs transition-all duration-300 hover:border-sky-400 hover:shadow-sm">
              ...
              <div>
                ...
                <p className="mt-0.5 text-[11px] text-slate-500">
                  Ultra-low latency conversational engine with instant speech
                  barge-in.
                </p>
              </div>
            </div>
        ...
        <footer className="relative z-10 mt-12 flex flex-col items-center justify-between border-t border-slate-200 pt-6 text-xs text-slate-500 sm:flex-row gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 text-center sm:text-left">
            ...
            >
              <Phone className="h-3 w-3 inline text-[#b8860b]" /> +91 91477
              68032
            </a>
          </div>
